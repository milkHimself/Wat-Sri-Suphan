      ...
      [{
        ...
        data: [{
          ...
          callback: function(e){
           ...
           if (pointer = 3, content.substr(selected.start-pointer,pointer) == '<b>') {
          ...
          callback: function(e){
            ...
            // transform selection and set the cursor into chunked text
            if (pointer = 3, content.substr(selected.start-pointer,pointer) == '<i>') {
              e.setSelection(selected.start-pointer,selected.end)
              e.replaceSelection(chunk)
              cursor = selected.start-pointer
            } else if (prevChar = content.substr(selected.start-1,1), !!prevChar && prevChar != '\n') {
          ...
          callback: function(e){
            ...
            // transform selection and set the cursor into chunked text
            if (pointer = 3, content.substr(selected.start-pointer,pointer) == '<h3>') {
              e.setSelection(selected.start-pointer,selected.end)
              e.replaceSelection(chunk)
              cursor = selected.start-pointer
            } else if (prevChar = content.substr(selected.start-1,1), !!prevChar && prevChar != '\n') {
        ...
        data: [{
          ...
          callback: function(e){
            ...
            if (link != null) {
			  ...
			  e.replaceSelection('<a href=\"'+link+'\">'+chunk+'</a>')
          ...
          callback: function(e){
            ...
            if (link != null) {
			  ...
			  e.replaceSelection('<img src=\"'+link+'\" alt=\"'+chunk+'\"/>')
